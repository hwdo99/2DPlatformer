...
public class ShowScoreboard : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        ScoreboardEnd = GameObject.FindWithTag("Scoreboardend").GetComponent<Text>();
    }

    // Update is called once per frame
    void Update()
    {
        ScoreboardEnd.text =  $"Your Score: {ScoreScript.currentScore}\n\n" + 
                           $"#1 HIGHSCORE: {PlayerPrefs.GetInt("High Score0")}\n" +
